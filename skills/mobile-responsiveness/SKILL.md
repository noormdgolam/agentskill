...
> Sourced from [hoodini/ai-agents-skills](https://github.com/hoodini/ai-agents-skills), installed 2026-08-04.
> Examples below are React/Tailwind-oriented; for vanilla CSS projects (like bongshaihousing.com,
> bongshaiskill's site), translate the breakpoint/hamburger-nav/fluid-typography *concepts*, not the JSX.
